...
export default function NetflowPane({ chain, isActive, selectedIndex, height, maxRows = 8, paneNumber, refreshTrigger = 0, onHighlight, onDataLength }: NetflowPaneProps) {
